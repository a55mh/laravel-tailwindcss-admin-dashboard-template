...
<div class="py-4">
    ...
    {{-- Modal Edit/Tambah --}}
    <x-modal-submit :open="$isOpen" title="{{ $donatur_id ? 'Edit Donatur' : 'Tambah Donatur' }}" yesText="Simpan">
        <form wire:submit.prevent="store">
            <div class="grid grid-cols-2 gap-2">
                ...
                <x-input-form label="PIC (Penanggung Jawab)" wire:model.defer="PIC" id="PIC" />
                <x-input-form label="Jabatan PIC (Penanggung Jawab)" wire:model.defer="jabatan" id="jabatan" />
                <x-input-form label="No Tlp PIC (Penanggung Jawab)" wire:model.defer="no_tlp_pic" id="no_tlp_pic" />
                <x-input-form label="Frekuensi Donasi (Bulan/Tahun)" wire:model.defer="freq_donasi" id="freq_donasi" />
